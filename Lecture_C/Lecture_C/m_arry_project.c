...
char* strAnimal[10]; // 10 개의 공간 배열을 만드는데, 그 안에 들어가는 데이터들이 캐릭터 포인터 형이라는 것
//char* cPtr = "테스트"; // 어떤 메모리 공간에 테스트라는 이름이 저장된 곳의 주소를 가진다는 뜻
...
void shuffleAnimal()
{
	...
	//ㅁㅁㅁㅁㅁ
	//ㅁㅁㅁㅁㅁ
	// 빈 공간을 랜덤으로 두 개를 찾아서 같은 동물 이름을 넣어줌
	// 한 번 할 때마다 두 번씩 동물 이름이 들어가야 함
