...
int main(void)
{
	...
	*/
	...
	// 야 내가 가지고 있던 거 이거야, 복사 해 줄게! 하고 주는 거지 내가 가진 것, 혹은 나 자체를 주는 것이 아님.
	// 나는 내 자리에 있으면서 내 거 복사해 주는거고, 내가 가서 내 걸 주는게 아님
	// == 주소는 그대로이면서 내 값도 그대로 내가 가지고 있고, 동일한 내용의 복사본을 주는 것
